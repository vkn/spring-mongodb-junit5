...
import static io.github.vkn.spring.mongodb.unit.MongoDbUnitCommandListener.MongoCommand;
import static io.github.vkn.spring.mongodb.unit.QueryVerifier.assertCounts;
...
class QueryVerifierTest {
    ...
    void failing() throws Exception {
        ...
        MongoDbUnitCommandListener listener = new MongoDbUnitCommandListener();
        assertThatThrownBy( () -> QueryVerifier.verify(method, listener))
